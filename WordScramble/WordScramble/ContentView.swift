...
struct ContentView: View {
    ...
    func isPossible(word: String) -> Bool {
        var rootWordAry = Array(rootWord)
        
        for char in word {
            
            if let idx = rootWordAry.firstIndex(of: char) {
                rootWordAry.remove(at: idx)
            } else {return false}
    ...
    func isReal(word: String) -> Bool {
        ...
        return misspelledRange.location == NSNotFound // no misspellings
    }
